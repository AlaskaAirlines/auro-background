...
var tokensCss = i$5`:host{--ds-auro-background-container-color: transparent}
`;
...
class AuroBackground extends i$2 {
  constructor() {
    super();
  ...
  render() {
    ...
    return x`
      <div class="background" style=${o(styles)}><slot></slot></div>
    `;
  }
}

export { AuroBackground as A };
